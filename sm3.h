...
/**
 * \brief               Output = genMessage (time4Intstr, seed32Hexstr)
 *
 * \param time4Intstr   8 bytes timestamp
 * \param seed32Hexstr  64 bytes seed
 */
...
/**
 * \brief               Output = rstotp (sm3_o)
 *
 * \param sm3_o         unsigned char[32] sm3 output
 */
void rstotp(sm3_context *ctx, unsigned char output[9]);
