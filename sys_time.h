...
/* refresh time , and get unix time stamp(unitï¼s),  timestamp since 1970 01.01 00:00:00*/
uint32_t get_unix_timestamp(void);

uint16_t get_sys_timestamp_ms(void);

/* refresh time , and get unix time stamp(unitï¼2.4414us),  timestamp since 1970 01.01 00:00:00*/
